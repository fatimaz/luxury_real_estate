            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        @endif
                        <h3 class="box-title">Control members</h3><br>
                            <a href="{{url('/adminpanel/users/create')}}" class="btn btn-primary pull-right ladda-button"><i class="glyphicon glyphicon-plus"></i> Add user</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="data" class="table table-bordered table-hover" >
                            ...
                            <tr>
                                ...
                                <th>My items</th>
                                <th>Validity</th>
                                    <!-- <th>Validity  hna nzid d oytre field</th>-->
                                <th>Control</th>
                            </tr>
                            </thead>
                            <tbody>
